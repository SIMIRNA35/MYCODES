...
public class ScrumTeam {
    ...
    public void removeTester( int employeeID) {
        testersList.removeIf(p -> p.employeeID == employeeID); // this is the method that can remove one employee object from the arrayLiST OF TESTER
    }
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number of testers =" + testersList.size() + // I changed here
